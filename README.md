...
workflow. The workflow runs the exact lock-selected toolchain twice, requires byte stability,
and commits the complete managed result without a manual repository sync.
